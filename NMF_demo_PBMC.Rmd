...
geneNMF.programs <- multiNMF(seu.list, assay="SCT", slot="data", k=4:9, nfeatures = 1000, center = F, scale=F)
#geneNMF.programs <- multiPCA(seu.list, assay="SCT", slot="data", k=4:9, nfeatures = 2000, center = F, scale=F)
```
...
ph <- plotMetaPrograms(geneNMF.metaprograms, similarity.cutoff = c(0,1))
```
